...
| | |
|---|---|
| **Dokumen** | Product Requirements Document — Versi 2.1 (Low Budget Adjusted) |
| **Nama Proyek** | WakeMeThere |
| **Platform** | Android (Fokus MVP awal) & iOS (Fase lanjutan) via Flutter |
...
Produk ini dirancang dengan arsitektur *mobile-first* menggunakan framework Flutter. Untuk menyesuaikan efisiensi anggaran, rilis MVP akan difokuskan pada platform Android (Google Play Store) terlebih dahulu. Fokus utama tahap pengembangan MVP ini adalah pembuktian keandalan *background location tracking* dan sistem alarm yang intrusif agar pengguna yang tertidur di kendaraan umum (KRL, MRT, Bus) dapat terbangun tepat waktu.
...
| OBJ-05 | Meluncurkan MVP fungsional di platform Android dalam batasan anggaran ketat (< Rp 7.500.000). |
...
## 20. Rencana Anggaran Biaya (RAB) - Penyesuaian Anggaran Ketat (Batas Rp 7.500.000)

RAB ini telah **direvisi secara drastis** untuk memenuhi batasan anggaran maksimal Rp 7.500.000. Untuk mencapai ini, pengembangan beralih dari tim profesional penuh waktu menjadi pengerjaan oleh **Solo Developer (Freelancer Profesional / Mahasiswa Tingkat Akhir yang sangat kompeten)**. Selain itu, **rilis awal hanya difokuskan untuk Android (Google Play Store)** sehingga mengeliminasi biaya tahunan lisensi Apple, menggunakan aset *open-source* (bebas biaya royalti desainer), dan meniadakan anggaran iklan/marketing berbayar.

### A. Biaya Pengembangan (Development Cost)
| Posisi / Peran | Tanggung Jawab & Deskripsi | Estimasi Biaya (IDR) |
| :--- | :--- | :--- |
| **Solo Mobile Developer** | Meng-cover koding aplikasi (Flutter), UI/UX dasar, integrasi Map API, Logic *Background Tracking*, & Internal Testing (All-in-one). | Rp 5.500.000 |
| **Sub-Total A** | | **Rp 5.500.000** |

### B. Biaya Infrastruktur & Lisensi (Tahun Pertama)
...
| **Apple Developer Program**| *Ditunda ke fase rilis berikutnya* (Untuk menghemat dana awal) | Rp 0 |
| **Google Maps / Firebase** | Penggunaan tier gratis (Free Tier API) | Rp 0 |
| **Asset Digital** | UI Kit & Ikon menggunakan perpustakaan *Open-Source* (Material Design dll) | Rp 0 |
| **Sub-Total B** | | **Rp 400.000** |

### C. Biaya Operasional (Opsional / Kontingensi)
| Pos Pengeluaran | Deskripsi | Estimasi Biaya (IDR) |
| :--- | :--- | :--- |
| **Field Test Transport** | Tiket E-Money (KRL/TransJakarta) untuk QA lapangan ke berbagai area rute | Rp 300.000 |
| **Biaya Tak Terduga (Buffer)**| Alokasi darurat untuk kuota server test, internet, perbaikan kritis mendesak | Rp 1.000.000 |
| **Sub-Total C** | | **Rp 1.300.000** |

**TOTAL ESTIMASI KESELURUHAN (A + B + C): Rp 7.200.000**
...
PRD WakeMeThere ini merinci tahapan pembangunan sistem alarm berbasis lokasi yang telah **disesuaikan sepenuhnya dengan batasan anggaran < Rp 7.500.000**. Pendekatan *lean development* dengan memanfaatkan *Solo Developer* dan memprioritaskan platform Android sebagai MVP pertama akan memastikan produk rilis tepat waktu (8 minggu). Risiko operasional diminimalisir dengan arsitektur efisien dan penggunaan aset yang bebas royalti.
